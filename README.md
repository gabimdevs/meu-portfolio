...
*   **JavaScript / TypeScript** — Lógica de programação e tipagem estática para maior segurança no código.
*   **React.js** — Biblioteca componentizada para construção de uma interface dinâmica.
...
*   **Projetos:** Galeria com os meus principais projetos desenvolvidos (como o *SystemResume*, *CoworkHub Reservation* e *StormTrack*), com links diretos para os repositórios.
...
```bash
   git clone [https://github.com/gabimdevs/meu-portfolio.git](https://github.com/gabimdevs/meu-portfolio.git)
```
